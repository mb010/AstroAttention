...
class playgroundv2(nn.Module):
    def __init__(self,aggregation_mode='concat',n_classes=2):
        ...
        self.conv1 = nn.Conv2d(in_channels=1,out_channels=filters[0],kernel_size=ksizes[0],padding=ksizes[0]//2,stride=1)
        self.relu1 = nn.ReLU()
        self.bnorm1 = nn.BatchNorm2d(filters[0])
        self.mpool1 = nn.MaxPool2d(kernel_size=2, stride=2)
        
        self.conv2 = nn.Conv2d(in_channels=filters[0],out_channels=filters[1],kernel_size=ksizes[1],padding=ksizes[1]//2,stride=1)
        self.relu2 = nn.ReLU()
        self.bnorm2 = nn.BatchNorm2d(filters[1])
        
        self.conv4 = nn.Conv2d(in_channels=filters[2],out_channels=filters[3],kernel_size=ksizes[3],padding=ksizes[3]//2,stride=1)
        self.relu4 = nn.ReLU()
        self.bnorm4 = nn.BatchNorm2d(filters[3])
        
        self.conv5 = nn.Conv2d(in_channels=filters[3],out_channels=filters[4],kernel_size=ksizes[4],padding=ksizes[4]//2,stride=1)
        self.relu5 = nn.ReLU()
        self.bnorm5 = nn.BatchNorm2d(filters[4])
        
        self.conv6 = nn.Conv2d(in_channels=filters[4],out_channels=filters[5],kernel_size=ksizes[5],padding=ksizes[5]//2,stride=1)
        self.relu6 = nn.ReLU()
    ...
    def forward(self,inputs):
        ...
        #g1.shape: [batch_size,32]
        #g2.shape: [batch_size,64]
        #poooled.shape: [batch_size,128]
